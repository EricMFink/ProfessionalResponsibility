...
# Rule 1.15 Safekeeping Property {% marginnote "margin-note-id" "The NC Rules on safekeeping client propery and funds are far more detailed than ABA Model Rule 1.15, which is provided here instead." %}
